...
export default function CBZConverterPage() {
  ...
  const handleGenerateTome = async () => {
    try {
      ...
      const filename = `${sanitizeFilename(formData.title)}.tome`;
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      <div className="mb-8">
        <h1 className="text-3xl font-bold mb-2">CBZ to Tome Converter</h1>
        <p className="text-muted-foreground">Convert your CBZ (comic book archive) files to Tome format</p>
      </div>
